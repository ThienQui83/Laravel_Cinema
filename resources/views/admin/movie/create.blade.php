                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input name="releaseDate"  id="releaseDate" class="form-control datepicker" placeholder="@lang('lang.select_date')" type="text">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="endDate">@lang('lang.end_date')</label>
                                            <input id="endDate" name="endDate" class="form-control datepicker" placeholder="@lang('lang.select_date')" type="text">
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
