                ...
                <div class="row">
                    <div class="col-8">
                        <div class="numbers">
                            ...
                            <span class="text-danger text-sm font-weight-bolder">@lang('lang.from_date') {!! date("d-m-Y",strtotime($year)) !!}
                            @lang('lang.to_date') {!! date("d-m-Y",strtotime($now)) !!}</span>
                        </div>
                    </div>
                    <div class="col-4 text-end">
                ...
                <div class="row">
                    <div class="col-8">
                        <div class="numbers">
                            ...
                            <p class="mb-0">
                                <span class="text-warning text-sm font-weight-bolder">@lang('lang.from_date') {!! date("d-m-Y",strtotime($year)) !!}
                                @lang('lang.to_date') {!! date("d-m-Y",strtotime($now)) !!}</span>
                            </p>
                        </div>
                    </div>
