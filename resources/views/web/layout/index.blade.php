...
<body id="top">
    ...
    <div class="user1" 
        style="background-image: url('\public\images\user1.jpg');">
    </div>
    ...
    <script>
        ...
        // Kiểm tra vị trí cuộn và hiển thị/ẩn nút cuộn lên
        window.onscroll = function () {
            const scrollBtn = document.getElementById("scrollBtn");
            if (document.body.scrollTop > 20 || document.documentElement.scrollTop > 20) {
                scrollBtn.style.display = "block"; // Hiển thị nút khi cuộn xuống
            } else {
                scrollBtn.style.display = "none"; // Ẩn nút khi ở đầu trang
            }
        };
    </script>
