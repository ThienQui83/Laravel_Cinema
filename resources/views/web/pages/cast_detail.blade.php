...
<section class="container-lg">
    ...
    <div class="movie mt-5 row">
                ...
                <div class="col-sm-6 col-lg-9">
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item d-flex align-items-center">
                            <strong class="pe-1">@lang('lang.national'):</strong> {!! $cast['national'] !!}
                        </li>
                        <li class="list-group-item d-flex align-items-center">
                            <strong class="pe-1">@lang('lang.birthday'):</strong> {!! $cast['birthday'] !!}
                        </li>
                    </ul>
                </div>
            </div>
        ...
        {{-- Sidebar for "Phim đang chiếu" --}}
        <div class="col-lg-3">
            <h4 class="mt-4">Phim đang chiếu</h4>
            <div class="list-group">
                @foreach($nowShowingMovies as $movie)
                    <a href="/movie/{!! $movie['id'] !!}" class="list-group-item list-group-item-action d-flex align-items-center">
                        <img src="{{ $movie['image'] }}" alt="{{ $movie['name'] }}" style="width: 50px; height: auto; margin-right: 10px;">
